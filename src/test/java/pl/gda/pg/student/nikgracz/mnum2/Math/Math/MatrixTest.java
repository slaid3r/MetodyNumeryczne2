...
public class MatrixTest {
    ...
    public void shouldGetSize() {
        Matrix matrix = new Matrix(MATRIX_ONE.length, MATRIX_ONE[0].length, MATRIX_ONE);
    ...
    public void shouldFailToResolveWithWrongMatrix() {
        Matrix matrix = new Matrix(TRANSPOSED_MATRIX.length, TRANSPOSED_MATRIX[0].length, TRANSPOSED_MATRIX);
        matrix.resolve();
    }
    ...
    public void shouldTranspose() {
        ...
        Matrix matrix = new Matrix(MATRIX_ONE.length, MATRIX_ONE[0].length, MATRIX_ONE);
        Matrix transposed = new Matrix(TRANSPOSED_MATRIX.length, TRANSPOSED_MATRIX[0].length, TRANSPOSED_MATRIX);
    ...
    public void shouldMultiplyBy() {
        ...
        Matrix matrix = new Matrix(MATRIX_TWO.length, MATRIX_TWO[0].length, MATRIX_TWO);
        Matrix multiplied = new Matrix(MULTIPLIED_MATRIX.length, MULTIPLIED_MATRIX[0].length, MULTIPLIED_MATRIX);
    ...
    public void shouldCreateIdentityMatrix() {
        ...
        Matrix expected = new Matrix(IDENTITY_MATRIX.length, IDENTITY_MATRIX[0].length, IDENTITY_MATRIX);
